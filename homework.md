[ссылке](https://github.com/netology-code/py-homeworks-basic/tree/master/6.classes)
([копия](students_and_mentor.py))
...
- Опирайтесь на принятые [правила оформления кода](https://github.com/netology-code/codestyle/tree/master/python) ([копия](codestyle_python.md)) чтобы выработать привычку писать профессионально. При несоблюдении принятого стиля домашние задания могут быть отправлены на доработку. 
